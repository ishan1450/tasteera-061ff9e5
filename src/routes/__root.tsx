...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Tasteera Cafe & Restaurant" },
      { property: "og:description", content: "Where every plate tells a story — Gurugram's warm, art-plated dining experience." },
